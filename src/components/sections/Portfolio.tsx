        ...
        {projetos.map((proj) =>
          proj.url ? (
            <motion.a
              ...
              className={
                `group relative bg-[#0F0F1E] border border-white/5 overflow-hidden rounded-xl transition-all duration-500 flex flex-col hover:border-codexo-primary/30 cursor-pointer shadow-2xl shadow-black/50`
              }
            >
            ...
            <div
              key={proj.id}
              className={
                `group relative bg-[#0F0F1E] border border-white/5 overflow-hidden rounded-xl transition-all duration-500 flex flex-col grayscale opacity-60 cursor-default`
              }
            >
              <div className="relative h-56 sm:h-64 bg-codexo-dark-light flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 bg-grid-white/[0.01] bg-[size:20px_20px]" />
