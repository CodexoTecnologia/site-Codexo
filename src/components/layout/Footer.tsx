      ...
      <div className="container mx-auto relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12 lg:gap-16 mb-12 sm:mb-16 md:mb-20">
          ...
          <div className="col-span-1 sm:col-span-2 space-y-5 sm:space-y-6 md:space-y-8">
            <Image 
              ...
              alt="Codexo Tecnologia - Desenvolvimento Web de Alta Performance" 
              width={140}
              height={40}
              unoptimized
          ...
          <div className="space-y-4 sm:space-y-5 md:space-y-6">
            ...
            <ul className="space-y-2 sm:space-y-3">
              {navLinks.map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="text-slate-300 text-[10px] sm:text-[11px] font-bold uppercase tracking-widest hover:text-white transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-6 sm:pt-8 md:pt-10 border-t border-white/5 gap-4 sm:gap-5 md:gap-6">
          <div className="flex items-center gap-3 sm:gap-4">
             <p className="text-[8px] sm:text-[9px] text-slate-400 font-bold uppercase tracking-[0.25em] sm:tracking-[0.3em] text-center md:text-left">
